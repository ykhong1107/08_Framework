 ...
 * - 응답 시 응답상태 코드를 지정하는 어노테이션
 *   
 * - HttpStatus.INTERNAL_SERVER_ERROR : 응답상태코드 500
 *   
 */
@ControllerAdvice
public class ErrorControllerAdvice {
	...
	public String dataAccessExceptionHandler(
		...
		e.printStackTrace(); // 콘솔에 자세한 예외내용을 출력
		
		model.addAttribute("errorMessage", "DB(SQL) 관련 오류발생");
	...
	@ResponseStatus(HttpStatus.BAD_REQUEST) // 400번
