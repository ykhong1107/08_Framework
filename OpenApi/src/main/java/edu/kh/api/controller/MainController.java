...
public class MainController {
    ...
    /* 제공 샘플과 다른부분 */
    // - 샘플 코드 수행 시 응답데이터에서 한글이 깨지는 문제 발생
    // -> charset=UTF-8을 추가하여 응답데이터의 문자 인코딩을 UTF-8로 지정
    // --> 한글깨짐 해결
...
//			model.addAttribute("item", items.get(0));
	...
	String serviceKey = "k5bbBry%2FPjYFdnEsLz1j5fXe3M5kqWYSgPvlDR7fik6lYZBObrSw6tT70AOMB%2F1Dg%2FuSkWrSlOhsNSkBChF6EQ%3D%3D";
